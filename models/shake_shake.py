# from https://github.com/hysts/pytorch_shake_shake/blob/master/shake_shake.py
import torch
import torch.nn as nn
import torch.nn.functional as F

from models.shake_func import get_alpha_beta, shake_function
from models.shake_config import *
...
def ShakeShake26_2x32d(num_classes):
    return Network(config=shake_26_2x32_config(), num_classes=num_classes)

def ShakeShake26_2x64d(num_classes):
    return Network(config=shake_26_2x64_config(), num_classes=num_classes)

def ShakeShake26_2x96d(num_classes):
    return Network(config=shake_26_2x96_config(), num_classes=num_classes)
